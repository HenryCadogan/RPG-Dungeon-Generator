...
public class Bestiary {
	...
	Monster vineBlight = new Monster("Vine Blight", "Constrict", "2d6 + 2", "Entangling Plants (Recharge 5-6)", "special, see Monster Manual page", 0.5, 26, 4, 12, 32);
	Monster dryad = new Monster("Dryad", "Club", "1d4/1d8 + 4 (with shillelagh)", "Fey Charm", "special, see Monster Manual page", 1, 22, 2, 11, 121);
	Monster quaggoth = new Monster("Quaggoth Spore Servant", "Claw (2 attacks)", "1d6 + 3", 1, 45, 5, 13, 230);
	Monster myconid = new Monster("Myconid Adult", "Fist", "2d4", "2x special attacks", "see Monster Manual page for special attacks", 0.5, 22, 2, 12, 232);
	...
	Monster brassWyrmling = new Monster("Brass Dragon Wyrmling", "Bite", "1d10 + 2", "Breath Weapons", "see Monster Manual page for special attacks", 1, 16, 4, 16, 106);
	Monster copperWyrmling = new Monster("Copper Dragon Wyrmling", "Bite", "1d10 + 2", "Breath Weapons", "see Monster Manual page for special attacks", 1, 22, 4, 16, 112);
