...
public class Dungeon {
	...
	public int endX;
	public int endY;
	private int minimum = 75;
	public int width;
	public int height;
	public int minRoomSize = 60;
	public boolean isConnected;
	
	public Dungeon leftChild;
	public Dungeon rightChild;
	public Dungeon room;
	
	public ArrayList <Dungeon> dungeons;
	public ArrayList <Dungeon> rooms;
	
	private Random rng = new Random();
	
	public JFrame dungeonFrame = new JFrame();
	
	//Used for creating dungeon and all split sections
	public Dungeon (int startX, int startY, int endX, int endY){
		this.startX = startX;
		this.startY = startY;
		this.endX = endX;
		this.endY = endY;
	...
	public void makeLeafs(Dungeon root){
	...
	public void drawDungeon(Dungeon root){
	...
	private void saveDungeon(Dungeon root, int[][] dungeon){
		...
		try{
			ImageIO.write(image, "png", new File("Dungeon.png"));
		}catch(IOException e){
