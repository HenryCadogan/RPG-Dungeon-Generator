...
public class Stocking {
	...
	private void determineRoomType(){
		...
		case 0: roomType = "generator.Monster";
				break;
	...
	private void monsterPlacement(PrintWriter write){
		...
		write.println();
		write.print("More information can be found about the monster on page " + chosenMonster.getPageNum() + " in the generator.Monster Manual (5th Edition)");
		write.println();
	}
	...
	private void trapPlacement(PrintWriter write){
		...
		write.print("More information can be found about the possible traps on pages 120-123 in the generator.Dungeon Masters Guide (5th Edition)");
		write.println();
	}
		...
		try{
			...
			for(Dungeon r : root.rooms){
				...
				if(isTreasure){
					...
					write.print("Treasure tables can be found in chapter 7 (p.137) of the generator.Dungeon Master's Guide (5th Edition)");
					write.println();
				}
